function getTotalBooksCount(books) {
  // find the amount of books in total
  return books.length 
}
...
function getBooksBorrowedCount(books) {
  // Find the total amount of books borrowed 
  const currentOutBooks = books.filter((books) =>books.borrows[0].returned === false);
  return currentOutBooks.length;
}  
